...
type Fallout struct {
	AvatarDamageDealt int32/*numeric*/ `json:"avatar_damage_dealt" xml:"avatar_damage_dealt" ` // Damage caused by Combat Reserves

	AvatarFrags int32/*numeric*/ `json:"avatar_frags" xml:"avatar_frags" ` // Destroyed by Combat Reserves

	AvgDamageAssisted float64/*float*/ `json:"avg_damage_assisted" xml:"avg_damage_assisted" ` // Average damage caused with your assistance

	AvgDamageAssistedRadio float64/*float*/ `json:"avg_damage_assisted_radio" xml:"avg_damage_assisted_radio" ` // Average damage upon your spotting

	AvgDamageAssistedTrack float64/*float*/ `json:"avg_damage_assisted_track" xml:"avg_damage_assisted_track" ` // Average damage upon your shooting the track
	...
	DeathCount int32/*numeric*/ `json:"death_count" xml:"death_count" ` // Deaths
	...
	FlagCapture int32/*numeric*/ `json:"flag_capture" xml:"flag_capture" ` // Flags captured in platoon

	FlagCaptureSolo int32/*numeric*/ `json:"flag_capture_solo" xml:"flag_capture_solo" ` // Flags captured as solo player
	...
	MaxDamage int32/*numeric*/ `json:"max_damage" xml:"max_damage" ` // Maximum damage caused in a battle

	MaxDamageTankId int32/*numeric*/ `json:"max_damage_tank_id" xml:"max_damage_tank_id" ` // Vehicle used to cause maximum damage

	MaxDamageWithAvatar int32/*numeric*/ `json:"max_damage_with_avatar" xml:"max_damage_with_avatar" ` // Maximum damage caused in one battle including damage from avatar

	MaxFrags int32/*numeric*/ `json:"max_frags" xml:"max_frags" ` // Maximum destroyed in battle

	MaxFragsTankId int32/*numeric*/ `json:"max_frags_tank_id" xml:"max_frags_tank_id" ` // Vehicle, in which maximum number of enemy vehicles was destroyed

	MaxFragsWithAvatar int32/*numeric*/ `json:"max_frags_with_avatar" xml:"max_frags_with_avatar" ` // Maximum destroyed in one battle including vehicles destroyed by avatar

	MaxWinPoints int32/*numeric*/ `json:"max_win_points" xml:"max_win_points" ` // Maximum Victory Points earned in Fallout

	MaxXp int32/*numeric*/ `json:"max_xp" xml:"max_xp" ` // Maximum experience per battle

	MaxXpTankId int32/*numeric*/ `json:"max_xp_tank_id" xml:"max_xp_tank_id" ` // Vehicle used to gain maximum experience per battle
	...
	ResourceAbsorbed int32/*numeric*/ `json:"resource_absorbed" xml:"resource_absorbed" ` // Resources captured at resource points
	...
	WinPoints int32/*numeric*/ `json:"win_points" xml:"win_points" ` // Victory Points
