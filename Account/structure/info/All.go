...
type All struct {
	AvgDamageAssisted float64 /*float*/ `json:"avg_damage_assisted" xml:"avg_damage_assisted" ` // Average damage caused with your assistance.value is calculated starting from version 8.8.

	AvgDamageAssistedRadio float64 /*float*/ `json:"avg_damage_assisted_radio" xml:"avg_damage_assisted_radio" ` // Average damage upon your spotting.value is calculated starting from version 8.8.

	AvgDamageAssistedTrack float64 /*float*/ `json:"avg_damage_assisted_track" xml:"avg_damage_assisted_track" ` // Average damage upon your shooting the track.value is calculated starting from version 8.8.
