...
type Vehicles struct {
	...
	NextTanks map[string]int/*associative array*/ `json:"next_tanks" xml:"next_tanks" ` // List of vehicles available for research in form of pairs:
	...
	PricesXp map[string]int/*associative array*/ `json:"prices_xp" xml:"prices_xp" ` // List of research costs in form of pairs:
